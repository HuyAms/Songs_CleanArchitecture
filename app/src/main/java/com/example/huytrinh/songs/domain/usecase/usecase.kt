package com.example.huytrinh.songs.domain.usecase
...
/**
 * A use case returns Completable as a result and needs 2 parameters.
 */
interface CompletableUseCaseWithParams<P, R> {
    fun execute(param1: P, param2: R): Completable
}